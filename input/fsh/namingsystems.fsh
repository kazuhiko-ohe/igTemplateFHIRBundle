...
Instance: mhlw-icd10-namingsystem
InstanceOf: NamingSystem
Usage: #definition
* name = "MHLW_ICD10FullDigits_NamingSystem"
* status = #active
* date = "2023-06-26"
* kind = #codesystem
* description = "JP Core for MHLW ICD10-2013 full digits NamingSystem"
//* uniqueId[+].type = #oid
//* uniqueId[+].type = #uri
* uniqueId[+].type = #uri
* uniqueId[=].value = "http://jpfhir.jp/fhir/core/mhlw/CodeSystem/ICD10-2013-full"
* uniqueId[=].preferred = true
* uniqueId[+].type = #uri
* uniqueId[=].value = "http://www.mhlw.go.jp/toukei/sippei/2013/ICD10-JP"
